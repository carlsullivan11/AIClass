...
def cross_validation(partition_num, df):
    ...
    results = ('Test_acc_all: ' , round(test_acc[0]/partition_num, 2) , '\n' ,
                'Train_acc_all: ' , round(train_acc[0]/partition_num, 2) , '\n' ,
                'Test_acc_error' , round(test_acc[1]/partition_num, 2) , '\n' ,
                'Train_acc_error' , round(train_acc[1]/partition_num, 2))
