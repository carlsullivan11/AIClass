from kNN_commented import kNN_commented
import pandas as pd

while(True):
    data_examples = {0: ['proj1/part1_b/data/labeled-examples', ' ', None], 
                    1: ['proj1/part1_b/data/diabetes.csv', ',', 0], 
                    2:['proj1/part1_b/data/airlines_delay.csv', ',', 0], 
                    3:['Run all', ' '], 
                    4: ['Enter Own', ' ']}
